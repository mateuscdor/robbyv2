...
function makeInMemoryStore() {
    /** @type {{ [jid: string]: { id: string, subject?: string, name?: string, isChats?: boolean, isContact?: boolean, presence?: import('@adiwajshing/baileys').PresenceData, metadata?: import('@adiwajshing/baileys').GroupMetadata } & import('@adiwajshing/baileys').Chat & import('@adiwajshing/baileys').Contact }}} */
    let chats = {}
    ...
    /**
     * @param {string} jid 
     * @param {(jid: string) => Promise<import('@adiwajshing/baileys').GroupMetadata>} groupMetadata 
     */
     ...
     * @param {{ groupMetadata: (jid: string, minimal?: boolean) => Promise<import('@adiwajshing/baileys').GroupMetadata> }} opts
     */
